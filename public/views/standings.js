    ...
    static get(data) {
        ...
        return /* html */`
            <div id="options">
                ...
                `).join(" | ")}<br />
                <span class="grey">Record Splits:</span> ${recordsTitle === "Map Records" ? "Map Records" : /* html */`<a href="/standings?records=map${season ? `&season=${season}` : ""}${map ? `&map=${map}` : ""}">Map Records</a>`} | ${recordsTitle === "Server Records" ? "Server Records" : /* html */`<a href="/standings?records=server${season ? `&season=${season}` : ""}${map ? `&map=${map}` : ""}">Server Records</a>`} | ${recordsTitle === "Team Size Records" ? "Team Size" : /* html */`<a href="/standings?records=size${season ? `&season=${season}` : ""}${map ? `&map=${map}` : ""}">Team Size</a>`}<br />
                ${maps.length > 0 ? /* html */`
