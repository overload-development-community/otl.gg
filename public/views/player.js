                ...
                <div id="performance">
                    <div id="opponents">
                        ...
                        ${opponents.map((s) => /* html */`
                            ...
                            <div class="match-time"><script>document.write(Common.formatDate(new Date("${s.bestMatchTime}")));</script></div>
