...
//  #   #   ###   #   #   ###     #     ###   #   #   ###    ## #    ##   #       ####   ###
/**
 * A command to remove a preferred neutral map from a team.
 */
class RemoveNeutral {
    //         #                ##           #
    //                           #           #
    ...
    static builder(builder) {
        builder
            ...
            .addStringOption((option) => option
                ...
                .setRequired(true))
            .setName("removeneutral")
            .setDescription("Removes a neutral map from your team.");
    }
    ...
    static async handle(interaction, user) {
        ...
        await Validation.teamShouldHaveNeutralSet(interaction, team, type, map, member);

        try {
            await team.removeNeutralMap(member, type, map.map);
        } catch (err) {
        ...
        await interaction.editReply({
            embeds: [
                Discord.embedBuilder({
                    description: `${member}, your preferred neutral map of **${map.map}** has been removed.`,
