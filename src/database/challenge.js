 ...
 * @typedef {import("./challenge.types").ClockRecordsets} ChallengeDbTypes.ClockRecordsets
 * @typedef {import("./challenge.types").CloseRecordsets} ChallengeDbTypes.CloseRecordsets
 * @typedef {import("./challenge.types").ConfirmGameTypeRecordsets} ChallengeDbTypes.ConfirmGameTypeRecordsets
 * @typedef {import("./challenge.types").CreateRecordsets} ChallengeDbTypes.CreateRecordsets
 * @typedef {import("./challenge.types").ExtendRecordsets} ChallengeDbTypes.ExtendRecordsets
 * @typedef {import("./challenge.types").GetAllByTeamRecordsets} ChallengeDbTypes.GetAllByTeamRecordsets
 * @typedef {import("./challenge.types").GetAllByTeamsRecordsets} ChallengeDbTypes.GetAllByTeamsRecordsets
 * @typedef {import("./challenge.types").GetByIdRecordsets} ChallengeDbTypes.GetByIdRecordsets
 * @typedef {import("./challenge.types").GetByTeamsRecordsets} ChallengeDbTypes.GetByTeamsRecordsets
 * @typedef {import("./challenge.types").GetCastDataRecordsets} ChallengeDbTypes.GetCastDataRecordsets
 * @typedef {import("./challenge.types").GetDamageRecordsets} ChallengeDbTypes.GetDamageRecordsets
 * @typedef {import("./challenge.types").GetDetailsRecordsets} ChallengeDbTypes.GetDetailsRecordsets
 * @typedef {import("./challenge.types").GetNotificationsRecordsets} ChallengeDbTypes.GetNotificationsRecordsets
 ...
 * @typedef {import("../models/challenge.types").CreateData} ChallengeTypes.CreateData
