        ...
        if (challenge) {
            ...
            if (!challenge.details.dateVoided) {
                ...
                res.status(200).send(await Common.page(
                    `<meta name="description" content="${challenge.challengingTeam.name} ${challenge.details.challengingTeamScore}, ${challenge.challengedTeam.name} ${challenge.details.challengedTeamScore}, ${challenge.details.map}${challenge.details.overtimePeriods ? ` ${challenge.details.overtimePeriods > 0 ? challenge.details.overtimePeriods : ""}OT` : ""}${challenge.details.matchTime ? ` , played ${challenge.details.matchTime.toLocaleString("en-us", {timeZone: "UTC", weekday: "long", year: "numeric", month: "long", day: "numeric", hour: "numeric", minute: "numeric"})} UTC` : ""}" />`,
